...
const ADMIN_NAV = [
  ...
  { key: 'users', name: 'Users & Admins', href: '/admins', icon: Users },
  { key: 'drivers', name: 'Drivers', href: '/admins', icon: Car },
  { key: 'pandits', name: 'Pandits', href: '/admins', icon: Flame },
  { key: 'hotels', name: 'Hotels', href: '/admins', icon: Hotel },
