  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-12 space-y-6">
      <div className="bg-white p-6 sm:p-8 rounded-3xl border border-gray-200 shadow-xl space-y-6">
        ...
        {/* Header Branding (Matching Create Yatri Account layout) */}
        ...
        {submitted ? (
          <div className="p-6 rounded-2xl bg-emerald-50 border border-emerald-200 text-center space-y-4 animate-fadeIn">
            ...
            <div className="space-y-1">
              ...
              <h2 className="font-serif font-bold text-xl text-[#2A180B]">Partner Application Submitted!</h2>
              <p className="text-xs text-gray-600">
                Your profile & verification documents have been securely uploaded to Supabase Storage and are currently pending review by GayaSeva Admin.
              </p>
            </div>
            ...
            <div className="pt-2 flex flex-col gap-2">
              <Link 
                href="/auth/login" 
                className="w-full py-3 bg-gradient-to-r from-[#F58220] to-[#E07210] text-white font-bold text-xs rounded-xl shadow-md flex items-center justify-center gap-2"
              >
